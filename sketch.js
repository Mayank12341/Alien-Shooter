...
function setup() {
  ...
  score=0;
  textSize(60);
  black = createSprite(width/2,height-height+35,1600,80)
  reload = createSprite(width/2+width/2-300,height-height+50,100,100);
  obstacle1= createSprite(width-width/2-590,height-300,200,30);
  ground= createSprite(width/2,height-10,1600,50);
  obstacle2 = createSprite(width/2,height/2+200,200,30);
  obstacle3=createSprite(width/2-200,height/2-200,200,30);
  obstacle4=createSprite(width/2-300,height/2,200,30);
  obstacle5=createSprite(width/2+180,height/2+30,200,30);
  obstacle6=createSprite(width/2+580,height/2-100,200,30);
  alien1=createSprite(width/2-590,height/2+30,50,50);
  alien2=createSprite(width/2-200,height/2-270,50,50);
  alien3=createSprite(width/2-300,height/2-70,50,50);
  alien4=createSprite(width/2+170,height/2-40,50,50);
  alien5=createSprite(width/2+590,height/2-170,200,30);
  alien6=createSprite(width/2,height/2+130,200,30);
  player= createSprite(width/2,height/2+300,50,50);
  healthTotal = createSprite(width/2-500,height/2-350,600,50);
  actualHealth= createSprite(width/2-500,height/2-350,600,50);
  health = createSprite(width/2-700,height/2-350,100,50);
  retry = createSprite(width/2-30,height/2,100,100);
  SCORE = createSprite(width/2,height/2-350,100,100);
  ...
  bullet=createSprite(width/2-width/2,height/2-height/2,90,10);
...
if(gamestate===play){
  ...
  if(player.x>width/2 && keyDown("UP_ARROW")){
  ...
  player.velocityY = player.velocityY + 0.8;   
    ...
    if(actualHealth.x<width/2-width+500){
